    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="relative z-10 flex min-h-full items-start justify-center px-2 py-3 sm:px-4 sm:py-6">
        <div
          ...
          className="surface-panel task-modal-panel animate-fade-in relative w-full max-w-2xl max-h-[calc(100vh-1.5rem)] overflow-y-auto rounded-[34px] p-6 sm:max-h-[min(88vh,54rem)] sm:p-8"
        >
